...
class AccountsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->boolean('fixed_variable')
            ->requirePresence('fixed_variable', 'create')
            ->notEmpty('fixed_variable');

        $validator
            ->boolean('personal_group')
            ->requirePresence('personal_group', 'create')
            ->notEmpty('personal_group');
