...
class CategoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'expense_income' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'ct_category_client' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id_client'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
